...
public class CustomerProjectModifyDemo6 {
	...
	static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(5000);
			oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys("Demo12");
			Thread.sleep(5000);
	...
	static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(5000);
			oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea")).sendKeys("Asharani");
			Thread.sleep(5000);			
