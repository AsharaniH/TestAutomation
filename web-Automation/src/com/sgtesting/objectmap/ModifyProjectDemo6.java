	...
	import org.openqa.selenium.WebDriver;
		...
		public class ModifyProjectDemo6 {
			...
			static void modifyproject()
			{
				try
				{
					oBrowser.findElement(objectmap.getLocator("modpr")).click();
					Thread.sleep(2000);
					oBrowser.findElement(objectmap.getLocator("modprowr")).sendKeys("Demo");
					Thread.sleep(3000);
					oBrowser.findElement(objectmap.getLocator("modprobtn")).click();
					Thread.sleep(2000);
				}catch(Exception e)
				{
					e.printStackTrace();
