package com.sgtesting.objectmap;
	...
	public static WebDriver oBrowser=null;
		...
		static void modifyuser()
		{
			try
			{
				oBrowser.findElement(objectmap.getLocator("moduserbtn")).click();
				Thread.sleep(2000);
				oBrowser.findElement(objectmap.getLocator("modpassword")).sendKeys("456");
				Thread.sleep(3000);
				oBrowser.findElement(objectmap.getLocator("modrepassword")).sendKeys("456");
				Thread.sleep(3000);
				oBrowser.findElement(objectmap.getLocator("modcreatebtn")).click();
				Thread.sleep(2000);
			}catch(Exception e)
			{
				e.printStackTrace();
